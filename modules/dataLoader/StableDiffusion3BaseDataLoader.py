...
class StableDiffusion3BaseDataLoader(
    ...
    def _preparation_modules(self, config: TrainConfig, model: StableDiffusion3Model):
        chunk_length = 75
        max_token_length = min(config.text_encoder_max_token_length, config.text_encoder_2_max_token_length)
        ...
        tokenize_prompt_3 = Tokenize(in_name='prompt', tokens_out_name='tokens_3', mask_out_name='tokens_mask_3', tokenizer=model.tokenizer_3, max_token_length=config.text_encoder_3_max_token_length)
