...
class StableDiffusionBaseDataLoader(
    ...
    def _preparation_modules(self, config: TrainConfig, model: StableDiffusionModel):
        ...
        tokenize_prompt = Tokenize(in_name='prompt', tokens_out_name='tokens', mask_out_name='tokens_mask', tokenizer=model.tokenizer, max_token_length=config.text_encoder_max_token_length)
