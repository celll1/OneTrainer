...
class StableDiffusionXLBaseDataLoader(
    ...
    def _preparation_modules(self, config: TrainConfig, model: StableDiffusionXLModel):
        ...
        # Use max_token_length from config for both tokenizers
        tokenize_prompt_1 = Tokenize(in_name='prompt', tokens_out_name='tokens_1', mask_out_name='tokens_mask_1', tokenizer=model.tokenizer_1, max_token_length=config.text_encoder_max_token_length)
        tokenize_prompt_2 = Tokenize(in_name='prompt', tokens_out_name='tokens_2', mask_out_name='tokens_mask_2', tokenizer=model.tokenizer_2, max_token_length=config.text_encoder_2_max_token_length)
        ...
        # Pass chunking parameters to EncodeClipText
        encode_prompt_1 = EncodeClipText(in_name='tokens_1', tokens_attention_mask_in_name=None, hidden_state_out_name='text_encoder_1_hidden_state', pooled_out_name=None, add_layer_norm=False, text_encoder=model.text_encoder_1, hidden_state_output_index=-(2 + config.text_encoder_layer_skip), autocast_contexts=[model.autocast_context], chunk_length=chunk_length, max_embeddings_multiples=max_embeddings_multiples, dtype=model.train_dtype.torch_dtype())
