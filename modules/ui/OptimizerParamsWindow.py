...
class OptimizerParamsWindow(ctk.CTkToplevel):
    ...
    def create_dynamic_ui(
        ...
        KEY_DETAIL_MAP = {
            ...
            'decouple_lr': {
                "title": "Decouple Learning Rate",
                "tooltip": "Whether to decouple the learning rate from weight decay",
                "type": "bool"
            },
            'max_lr': {
                "title": "Maximum Learning Rate",
                "tooltip": "Maximum learning rate value",
                "type": "float"
            },
            'kahan_sum': {
                "title": "Kahan Summation",
                "tooltip": "Whether to use Kahan summation for more accurate floating-point arithmetic",
                "type": "bool"
            }
        }
        # @formatter:on
